...
const tracks: Track[] = [
  {
    title: 'Crazy Frog',
    artist: 'Crazy Frog',
    url: '/audio/CrazyFrog.mp3', // ✅ Masz już
  },
  ...
  // 🎸 LINKIN PARK CLASSICS
  {
    title: 'In the End',
    artist: 'Linkin Park',
    url: '/audio/linkin_park_in_the_end.mp3',
  },
  {
    title: 'Numb',
    artist: 'Linkin Park',
    url: '/audio/linkin_park_numb.mp3',
  },
  ...
  // 👑 BRITNEY CLASSICS
  {
    ...
    url: '/audio/britney_oops.mp3',
  },
  {
    title: '...Baby One More Time',
    artist: 'Britney Spears',
    url: '/audio/britney_baby_one_more_time.mp3',
  },
  ...
  // 🎤 EMINEM HITS
  {
    ...
    artist: 'Eminem',
    url: '/audio/eminem_real_slim_shady.mp3',
  },
  {
    title: 'Lose Yourself',
    artist: 'Eminem',
    url: '/audio/eminem_lose_yourself.mp3',
  },
  {
    title: 'Without Me',
    artist: 'Eminem',
    url: '/audio/eminem_without_me.mp3',
  },
  ...
  // 🇵🇱 KRZYSZTOF KRAWCZYK
  {
    ...
    url: '/audio/krawczyk_jak_minal_dzien.mp3',
  },
  {
    title: 'Parostatek',
    artist: 'Krzysztof Krawczyk',
    url: '/audio/krawczyk_parostatek.mp3',
  },
  ...
  // 🇲🇩 DRAGOSTEA DIN TEI ERA
  {
    ...
    artist: 'O-Zone',
    url: '/audio/ozone_dragostea_din_tei.mp3',
  },
  ...
  // 🎵 INNE HITY 2000s
  {
    ...
    artist: 'Evanescence',
    url: '/audio/evanescence_bring_me_to_life.mp3',
  },
  {
    title: 'Butterfly',
    artist: 'Crazy Town',
    url: '/audio/crazy_town_butterfly.mp3',
  },
  {
    title: 'Hot in Herre',
    artist: 'Nelly',
    url: '/audio/nelly_hot_in_herre.mp3',
  },
  {
    title: 'Complicated',
    artist: 'Avril Lavigne',
    url: '/audio/avril_complicated.mp3',
  },
  {
    title: 'Żeby Polska',
    artist: 'Blog 27',
    url: '/audio/blog27_zeby_polska.mp3',
  },
];
